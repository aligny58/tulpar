...
const ShiftTab=({team,teamMembers,phantomMembers=[],setPhantomMembers,user,t})=>{
  ...
  const[previewShifts,setPreviewShifts]=useState(null); // [{name,position,date,start,end}] | null
  // Manual add state
  const[showNew,setShowNew]=useState(false);
  ...
  const handleFileChange=async(e)=>{
    ...
    try{
      ...
      // Düzleştir: AI {shifts:[{name,entries:[]}]} dönüyor, biz [{name,date,start,end}] olarak tutuyoruz
      const flat=[];
